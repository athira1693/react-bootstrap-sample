            ...
            <div className='row flex-row'>
                <Col className='p-2 pe-1 col-7'>
                    <Card.Text >
                        ...
                        <div className='d-flex ms-2 mb-2 align-items-center'>
                            ...
                            <span><i class="fa fa-regular fa-check-circle" style={{color:'#4bb7c8'}}></i></span>
                        </div>
                        <p className='mb-1'>
                            Reserve price
                        </p>
                        ...
                        <i class="fa fa-solid fa-sort-up" onClick={()=>handleIncrement()}></i>
                        <i class="fa fa-solid fa-sort-down" onClick={()=>handleDecrement()} style={{ marginTop: '-0.3rem'}}></i> 
                        </span>
                        <span className='me-2'>
                ...
                <Col className='p-2 ps-0 col-5'>
                    ...
                    <Button variant='text' className='bid-button' style={{color:'#fff'}}>
                        Place Bid 
                        <i class="ms-1 fa fa-thin fa-arrow-right"></i>
                    </Button>
                   </Card.Text>
                </Col>
            </div>
